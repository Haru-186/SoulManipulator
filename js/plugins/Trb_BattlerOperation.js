...
Game_Interpreter.prototype.pluginCommand = function(command, args) {
    ...
    var args_T = [];
    if(command == 'ACTORMOVE'){
        for(var i = 0; i < args.length; i++){
            args_T[i] = eval(args[i]);
        }
